...
def public_call_metadata(value: Any) -> dict[str, Any] | None:
    ...
    if isinstance(runtime, dict):
        ...
        string_fields = {
            ...
            "knowledge_repair_transport_status",
            "speech_provider",
            "llm_provider",
            "llm_model",
            "voice_runtime",
            ...
            "tts_transport_preconnect_status",
        ...
        numeric_fields = {
            ...
            "mcp_presentation_usage_reported",
            "mcp_presentation_last_ms",
            ...
            "knowledge_repair_transport_prepare_ms",
            "knowledge_repair_transport_client_uses",
            ...
            "tts_transport_preconnect_ms",
            "tts_transport_preconnect_text_characters",
