"""Publish immutable serving revisions for approved pre-migration knowledge bases."""
...
from app.services.knowledge_serving import backfill_approved_serving_revisions_batch
...
def main() -> None:
    ...
    print(
        f"Published {result.published} immutable knowledge serving revision(s); "
