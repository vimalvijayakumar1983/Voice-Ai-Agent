"""Align the knowledge-source full-text index with the retrieval query.

Revision ID: 20260910_026
Revises: 20260909_025
...
turn recomputed ``to_tsvector`` over each source's full text.
"""
...
revision: str = "20260910_026"
down_revision: str | None = "20260909_025"
