...
| Search knowledge base | `GET /api/v1/knowledge/{id}/search?q=` | Text scan of every source's extracted text and verified facts, plus a preview of the evidence the agent would retrieve for that question (approved release, or draft sources before approval) |
